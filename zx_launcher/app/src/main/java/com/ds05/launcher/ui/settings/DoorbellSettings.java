...
//wangjun add begin
    private SwitchPreference doorlightSwitch;
//wangjun add end
...
//wangjun start
        doorlightSwitch = (SwitchPreference)findPreference(KEY_DOORBELL_LIGHT);
        doorlightSwitch.setOnPreferenceChangeListener(this);
//wangjun end
...
//wangjun add begin
          ...
          intent.putExtra(HWSink.EXTRA_DRV_CFG_DOOR_LIGHT, value?1:0);
	  Log.e("XXX","wangjun-----send BC--value:" + value);
	  PrefDataManager.setDoorbellLight(value);
